  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0A' }}>
      ...
      <section id="how" style={sectionStyle}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          <Badge label="4 ШАГА" />
          <h2 style={{ fontFamily: 'Exo 2, sans-serif', fontSize: 'clamp(22px, 4vw, 38px)', fontWeight: 800, margin: '12px 0 8px', color: '#fff' }}>
      ...
      <section id="benefits" style={sectionStyle}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <h2 style={{ fontFamily: 'Exo 2, sans-serif', fontSize: 'clamp(22px, 4vw, 38px)', fontWeight: 800, margin: '12px 0 36px', color: '#fff' }}>
            Выгоды для блогера
          </h2>
        </motion.div>
