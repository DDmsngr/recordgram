    ...
    <div style={{ minHeight: '100vh', background: '#0A0A0A' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 48, flexWrap: 'wrap' }}>
          <div style={{ flex: '1 1 400px', maxWidth: 560 }}>
            ...
            <motion.h1
              ...
              style={{ fontFamily: 'Unbounded, sans-serif', fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: 900, lineHeight: 1.1, letterSpacing: '-1px', margin: '0 0 20px' }}
            >
      ...
      <section id="how" style={sectionStyle}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: 800, margin: '12px 0 40px', color: '#fff' }}>
            Как это работает
          </h2>
        </motion.div>
      ...
      <section id="records" style={sectionStyle}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: 800, margin: '12px 0 8px', color: '#fff' }}>
            Что можно побить
          </h2>
      ...
      <section style={sectionStyle}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontSize: 'clamp(22px, 4vw, 38px)', fontWeight: 800, margin: '0 0 40px', color: '#fff' }}>
